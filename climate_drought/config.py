...
class CDIArgs(AnalysisArgs):
    def __init__(self, latitude, longitude, start_date, end_date, spi_source='GDO',sma_source='GDO', sma_var=None):
        ...
        self.sma_var = sma_var or ('smant' if sma_source=='GDO' else 'zscore_swvl3')
        self.fpr_var = 'fpanv'

class Config():
    def __init__(self,outdir='output',indir='input',verbose=True,baseline_start='19850101',baseline_end='20221231',aws=False,era_daily=True):
        self.outdir = outdir
        self.indir = indir
